...
/*
 * Base class for textures. Was originally the main texture class but now is just used as a base for other types of textures.
 */
abstract class AbstractTexture {
	public static final AbstractTexture defaultTexture = new Texture("textures/test_texture.png");
	private int id;
	private int width = 0;
	...
	private AbstractTexture(String path, int startX, int startY, int width, int height) {
